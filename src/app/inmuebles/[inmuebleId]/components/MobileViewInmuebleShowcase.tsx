...
import InmuebleInfoShowcaseMobile from "@/app/inmuebles/[inmuebleId]/components/InmuebleInfoShowcaseMobile";
...
export default function DesktopViewInmuebleShowcase({ inmueble, loading }: { inmueble: Inmueble; loading?: boolean }) {
    ...
    return (
        <section className="flex flex-col w-full py-4 p-2">
            ...
            <section className="flex flex-col w-full h-full gap-4 items-center">
                ...
                <section className="flex flex-col w-screen gap-4">
                    ...
                    <Swiper
                        ...
                        spaceBetween={10}
                        slidesPerView={1}
                        className="w-full h-[500px] object-cover custom-swiper"
                        loop
                    >
                    ...
                    {/* Showcase */}
                    <InmuebleInfoShowcaseMobile inmueble={inmueble} />
                </section>
                        ...
                        <div className=" rounded-lg bg-white/70">
                            ...
                            <section className="flex flex-wrap gap-2 p-2 items-center">
                                {inmueble.caracteristicas?.servicios?.map((servicio, index) => (
                                    <Chip className="uppercase" key={index} color="warning" variant="flat">
                                        {servicio.nombre}
                                    </Chip>
                                ))}
                            </section>
